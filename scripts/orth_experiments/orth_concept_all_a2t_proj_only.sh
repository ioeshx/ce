...
echo "[INFO] Running Orthogonal Projection Experiment: orth_concept_all_a2t_proj_only"
...
res_dir="result/orth/${target}_to_${anchor_slug}_proj_a2t_proj_only"
...
echo "[DONE] orth_concept_all_a2t_proj_only"
