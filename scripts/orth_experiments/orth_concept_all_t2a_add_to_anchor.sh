...
echo "[INFO] Running Orthogonal Projection Experiment: orth_concept_all_t2a_add_to_anchor"
...
res_dir="result/orth/${target}_to_${anchor_slug}_proj_t2a_add_to_anchor"
...
echo "[DONE] orth_concept_all_t2a_add_to_anchor"
