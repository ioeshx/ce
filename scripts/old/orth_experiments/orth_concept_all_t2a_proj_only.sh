...
echo "[INFO] Running Orthogonal Projection Experiment: orth_concept_all_t2a_proj_only"
...
res_dir="result/orth/${target}_to_${anchor_slug}_proj_t2a_proj_only"
...
echo "[DONE] orth_concept_all_t2a_proj_only"
